<!--header-->
		...
		<div class="top-header navbar navbar-default"><!--header-one-->
			<div class="container">
				<div class="nav navbar-nav wow fadeInLeft animated" data-wow-delay=".5s">
					<p>Send Your Advertisement<a href="contact.php">Click Here </a></p>
				</div>
		...
		<div class="header-two navbar navbar-default"><!--header-two-->
			<div class="container">
				<div class="nav navbar-nav header-two-left">
					<ul>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91 9636386222</li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91 9587615254</li>
						
								
					</ul>
				</div>
				<div class="nav navbar-nav logo wow zoomIn animated" data-wow-delay=".7s">
					<h1><a href="index.php">Jalore <b>Times</b><span class="tag">Make Your Business Online </span> </a></h1>
				</div>
				<div class="nav navbar-nav navbar-right header-two-right"  style="margin-left:-70px;">
					<div class="header-right my-account">
						<a href="#"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span><font size="3"> How We Advertise ?</a>	</font>					
					</div>
				...
				<nav class="navbar" role="navigation">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav top-nav-info">
							...
							<li class="dropdown"> 	
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Free Add<b class="caret"></b></a>
							...
							<li class="dropdown grid">
								<a href="#" class="dropdown-toggle list1" data-toggle="dropdown">Education<b class="caret"></b></a>
							...
							<li class="dropdown grid">
								<a href="#" class="dropdown-toggle list1" data-toggle="dropdown">Entertainment<b class="caret"></b></a>
								<ul class="dropdown-menu multi-column menu-two multi-column3">
									<div class="row">
										<div class="col-sm-4 menu-grids">
											<ul class="multi-column-dropdown">
												<li><a class="list" href="products.html">Dance Classes</a></li>
							...
							<li class="dropdown grid">
								<a href="#" class="dropdown-toggle list1" data-toggle="dropdown">Hotels <b class="caret"></b></a>
							...
							<li class="dropdown"> 	
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">Govt Add<b class="caret"></b></a>
								<ul class="dropdown-menu multi-column multi-column1">
									<div class="row">
										<div class="col-sm-4 menu-grids menulist1">
											<h4>Banks</h4>
							...
							<li><a href="contact.php">Videos</a></li>
	...
	<header class="cd-main-header" style="margin-left:230px;">
